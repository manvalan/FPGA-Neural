...
module tb #(
    ...
    nms_neural_multiprocessor #(
        ...
        .MAX_TILES(16), .PSRAM_DATA_WIDTH(PSRAM_DATA_WIDTH), .CLK_FREQ_MHZ(80)
    ) u_nmp (
        .clk(clk), .rst(rst),
    ...
    initial begin
        ...
        $display("========================================");
        $display("NMS D-Stress benchmark (STEP9, real V1 PSRAM chain) -- N_SLOTS_CFG=%0d", N_SLOTS_CFG);
        $display("========================================");
