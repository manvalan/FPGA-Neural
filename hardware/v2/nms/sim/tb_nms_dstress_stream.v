...
module tb #(
    ...
    nms_neural_multiprocessor_stream #(
    ...
    initial begin
        ...
        $display("========================================");
        $display("NMS D-Stress benchmark (STEP13, weight prefetch + CONTINUOUS TILE STREAM, real V1 PSRAM chain) -- N_SLOTS_CFG=%0d PFD_CFG=%0d", N_SLOTS_CFG, PFD_CFG);
        $display("========================================");
