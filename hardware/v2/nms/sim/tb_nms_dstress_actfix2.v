...
module tb #(
    ...
    nms_neural_multiprocessor_actfix2 #(
    ...
    initial begin
        ...
        $display("========================================");
        $display("NMS D-Stress benchmark (STEP14 Part B, streaming + activation-fill timing fix, real V1 PSRAM chain) -- N_SLOTS_CFG=%0d PFD_CFG=%0d", N_SLOTS_CFG, PFD_CFG);
        $display("========================================");
        ...
        $display("========================================");
        if (errors == 0)
            $display("ALL %0d WORKLOAD SUITES PASSED (N_SLOTS_CFG=%0d, PFD_CFG=%0d, real V1 PSRAM chain, real slot_mem_arbiter, weight_prefetch_engine + continuous tile stream)", tests, N_SLOTS_CFG, PFD_CFG);
        else
