...
wire          crg_clkout1;
wire          crg_locked;
reg    [15:0] crg_por_count = 16'hffff;
wire          crg_por_done;
wire          crg_reset0;
wire          crg_reset1;
reg           crg_rst = 1'd0;
...
wire    [1:0] csrbank1_dly_sel_r;
reg           csrbank1_dly_sel_re = 1'd0;
wire    [1:0] csrbank1_dly_sel_w;
reg           csrbank1_dly_sel_we = 1'd0;
wire          csrbank1_sel;
...
wire          ddrphy_burstdet_seen_rd_stb;
reg     [1:0] ddrphy_burstdet_seen_status = 2'd0;
reg           ddrphy_burstdet_seen_wr_stb = 1'd0;
...
reg           ddrphy_dly_sel_wr_stb = 1'd0;
...
reg           init_done_wr_stb = 1'd0;
reg           init_error_storage = 1'd0;
reg           init_error_wr_stb = 1'd0;
wire          init_rst;
...
reg           litedramcore_phaseinjector0_address_wr_stb = 1'd0;
reg     [2:0] litedramcore_phaseinjector0_baddress_storage = 3'd0;
reg           litedramcore_phaseinjector0_baddress_wr_stb = 1'd0;
wire          litedramcore_phaseinjector0_cas;
...
reg           litedramcore_phaseinjector0_command_wr_stb = 1'd0;
wire          litedramcore_phaseinjector0_cs;
wire          litedramcore_phaseinjector0_cs_bottom;
wire          litedramcore_phaseinjector0_cs_top;
wire          litedramcore_phaseinjector0_ras;
wire          litedramcore_phaseinjector0_rddata_rd_stb;
reg    [63:0] litedramcore_phaseinjector0_rddata_status = 64'd0;
reg           litedramcore_phaseinjector0_rddata_wr_stb = 1'd0;
wire          litedramcore_phaseinjector0_rden;
wire          litedramcore_phaseinjector0_we;
reg    [63:0] litedramcore_phaseinjector0_wrdata_storage = 64'd0;
reg           litedramcore_phaseinjector0_wrdata_wr_stb = 1'd0;
wire          litedramcore_phaseinjector0_wren;
reg    [14:0] litedramcore_phaseinjector1_address_storage = 15'd0;
reg           litedramcore_phaseinjector1_address_wr_stb = 1'd0;
reg     [2:0] litedramcore_phaseinjector1_baddress_storage = 3'd0;
reg           litedramcore_phaseinjector1_baddress_wr_stb = 1'd0;
wire          litedramcore_phaseinjector1_cas;
...
reg           litedramcore_phaseinjector1_command_wr_stb = 1'd0;
wire          litedramcore_phaseinjector1_cs;
wire          litedramcore_phaseinjector1_cs_bottom;
wire          litedramcore_phaseinjector1_cs_top;
wire          litedramcore_phaseinjector1_ras;
wire          litedramcore_phaseinjector1_rddata_rd_stb;
reg    [63:0] litedramcore_phaseinjector1_rddata_status = 64'd0;
reg           litedramcore_phaseinjector1_rddata_wr_stb = 1'd0;
wire          litedramcore_phaseinjector1_rden;
wire          litedramcore_phaseinjector1_we;
reg    [63:0] litedramcore_phaseinjector1_wrdata_storage = 64'd0;
reg           litedramcore_phaseinjector1_wrdata_wr_stb = 1'd0;
wire          litedramcore_phaseinjector1_wren;
...
reg    [26:0] litedramcore_zqcs_timer_count1 = 27'd74999999;
...
assign crg_clkin_signal = clk;
assign sys2x_i_clk = crg_clkout0;
assign init_clk = crg_clkout1;
assign crg_locked = (ecp5pll_locked & (~crg_reset1));
always @(*) begin
...
always @(*) begin
    ...
    if (litedramcore_phaseinjector0_command_issue_re) begin
        if (litedramcore_phaseinjector0_cs_top) begin
            litedramcore_csr_dfi_p0_cs_n = 2'd2;
        end else begin
            if (litedramcore_phaseinjector0_cs_bottom) begin
                litedramcore_csr_dfi_p0_cs_n = 1'd1;
            end else begin
                litedramcore_csr_dfi_p0_cs_n = {1{(~litedramcore_phaseinjector0_cs)}};
            end
        end
        litedramcore_csr_dfi_p0_we_n = (~litedramcore_phaseinjector0_we);
        litedramcore_csr_dfi_p0_cas_n = (~litedramcore_phaseinjector0_cas);
        litedramcore_csr_dfi_p0_ras_n = (~litedramcore_phaseinjector0_ras);
    end else begin
...
assign litedramcore_csr_dfi_p0_wrdata_en = (litedramcore_phaseinjector0_command_issue_re & litedramcore_phaseinjector0_wren);
assign litedramcore_csr_dfi_p0_rddata_en = (litedramcore_phaseinjector0_command_issue_re & litedramcore_phaseinjector0_rden);
...
always @(*) begin
    ...
    if (litedramcore_phaseinjector1_command_issue_re) begin
        if (litedramcore_phaseinjector1_cs_top) begin
            litedramcore_csr_dfi_p1_cs_n = 2'd2;
        end else begin
            if (litedramcore_phaseinjector1_cs_bottom) begin
                litedramcore_csr_dfi_p1_cs_n = 1'd1;
            end else begin
                litedramcore_csr_dfi_p1_cs_n = {1{(~litedramcore_phaseinjector1_cs)}};
            end
        end
        litedramcore_csr_dfi_p1_we_n = (~litedramcore_phaseinjector1_we);
        litedramcore_csr_dfi_p1_cas_n = (~litedramcore_phaseinjector1_cas);
        litedramcore_csr_dfi_p1_ras_n = (~litedramcore_phaseinjector1_ras);
    end else begin
...
assign litedramcore_csr_dfi_p1_wrdata_en = (litedramcore_phaseinjector1_command_issue_re & litedramcore_phaseinjector1_wren);
assign litedramcore_csr_dfi_p1_rddata_en = (litedramcore_phaseinjector1_command_issue_re & litedramcore_phaseinjector1_rden);
...
assign litedramcore_choose_cmd_cmd_valid = rhs_self8;
assign litedramcore_choose_cmd_cmd_payload_a = rhs_self9;
assign litedramcore_choose_cmd_cmd_payload_ba = rhs_self10;
assign litedramcore_choose_cmd_cmd_payload_is_read = rhs_self11;
assign litedramcore_choose_cmd_cmd_payload_is_write = rhs_self12;
assign litedramcore_choose_cmd_cmd_payload_is_cmd = rhs_self13;
always @(*) begin
...
assign litedramcore_choose_req_cmd_valid = rhs_self14;
assign litedramcore_choose_req_cmd_payload_a = rhs_self15;
assign litedramcore_choose_req_cmd_payload_ba = rhs_self16;
assign litedramcore_choose_req_cmd_payload_is_read = rhs_self17;
assign litedramcore_choose_req_cmd_payload_is_write = rhs_self18;
assign litedramcore_choose_req_cmd_payload_is_cmd = rhs_self19;
always @(*) begin
...
assign litedramcore_interface_bank0_addr = rhs_self20;
assign litedramcore_interface_bank0_we = rhs_self21;
assign litedramcore_interface_bank0_valid = rhs_self22;
...
assign litedramcore_interface_bank1_addr = rhs_self23;
assign litedramcore_interface_bank1_we = rhs_self24;
assign litedramcore_interface_bank1_valid = rhs_self25;
...
assign litedramcore_interface_bank2_addr = rhs_self26;
assign litedramcore_interface_bank2_we = rhs_self27;
assign litedramcore_interface_bank2_valid = rhs_self28;
...
assign litedramcore_interface_bank3_addr = rhs_self29;
assign litedramcore_interface_bank3_we = rhs_self30;
assign litedramcore_interface_bank3_valid = rhs_self31;
...
assign litedramcore_interface_bank4_addr = rhs_self32;
assign litedramcore_interface_bank4_we = rhs_self33;
assign litedramcore_interface_bank4_valid = rhs_self34;
...
assign litedramcore_interface_bank5_addr = rhs_self35;
assign litedramcore_interface_bank5_we = rhs_self36;
assign litedramcore_interface_bank5_valid = rhs_self37;
...
assign litedramcore_interface_bank6_addr = rhs_self38;
assign litedramcore_interface_bank6_we = rhs_self39;
assign litedramcore_interface_bank6_valid = rhs_self40;
...
assign litedramcore_interface_bank7_addr = rhs_self41;
assign litedramcore_interface_bank7_we = rhs_self42;
assign litedramcore_interface_bank7_valid = rhs_self43;
...
assign user_port_wdata_ready = new_master_wdata_ready3;
assign user_port_rdata_valid = new_master_rdata_valid13;
always @(*) begin
...
assign csrbank0_init_done_w = init_done_storage;
assign csrbank0_init_error_w = init_error_storage;
assign csrbank1_sel = (interface1_bank_bus_adr[13:9] == 1'd1);
assign csrbank1_dly_sel_r = interface1_bank_bus_dat_w[1:0];
always @(*) begin
    csrbank1_dly_sel_re = 1'd0;
    csrbank1_dly_sel_we = 1'd0;
    if ((csrbank1_sel & (interface1_bank_bus_adr[8:0] == 1'd0))) begin
        csrbank1_dly_sel_re = interface1_bank_bus_we;
        csrbank1_dly_sel_we = interface1_bank_bus_re;
    end
end
...
assign csrbank1_dly_sel_w = ddrphy_dly_sel_storage;
assign csrbank1_burstdet_seen_w = ddrphy_burstdet_seen_status;
assign ddrphy_burstdet_seen_rd_stb = csrbank1_burstdet_seen_we;
...
assign csrbank2_dfii_control_w = litedramcore_storage;
assign litedramcore_phaseinjector0_cs = litedramcore_phaseinjector0_command_storage[0];
assign litedramcore_phaseinjector0_we = litedramcore_phaseinjector0_command_storage[1];
assign litedramcore_phaseinjector0_cas = litedramcore_phaseinjector0_command_storage[2];
assign litedramcore_phaseinjector0_ras = litedramcore_phaseinjector0_command_storage[3];
assign litedramcore_phaseinjector0_wren = litedramcore_phaseinjector0_command_storage[4];
assign litedramcore_phaseinjector0_rden = litedramcore_phaseinjector0_command_storage[5];
assign litedramcore_phaseinjector0_cs_top = litedramcore_phaseinjector0_command_storage[6];
assign litedramcore_phaseinjector0_cs_bottom = litedramcore_phaseinjector0_command_storage[7];
assign csrbank2_dfii_pi0_command_w = litedramcore_phaseinjector0_command_storage;
assign csrbank2_dfii_pi0_address_w = litedramcore_phaseinjector0_address_storage;
assign csrbank2_dfii_pi0_baddress_w = litedramcore_phaseinjector0_baddress_storage;
...
assign litedramcore_phaseinjector0_rddata_rd_stb = csrbank2_dfii_pi0_rddata0_we;
assign litedramcore_phaseinjector1_cs = litedramcore_phaseinjector1_command_storage[0];
assign litedramcore_phaseinjector1_we = litedramcore_phaseinjector1_command_storage[1];
assign litedramcore_phaseinjector1_cas = litedramcore_phaseinjector1_command_storage[2];
assign litedramcore_phaseinjector1_ras = litedramcore_phaseinjector1_command_storage[3];
assign litedramcore_phaseinjector1_wren = litedramcore_phaseinjector1_command_storage[4];
assign litedramcore_phaseinjector1_rden = litedramcore_phaseinjector1_command_storage[5];
assign litedramcore_phaseinjector1_cs_top = litedramcore_phaseinjector1_command_storage[6];
assign litedramcore_phaseinjector1_cs_bottom = litedramcore_phaseinjector1_command_storage[7];
assign csrbank2_dfii_pi1_command_w = litedramcore_phaseinjector1_command_storage;
assign csrbank2_dfii_pi1_address_w = litedramcore_phaseinjector1_address_storage;
assign csrbank2_dfii_pi1_baddress_w = litedramcore_phaseinjector1_baddress_storage;
...
assign litedramcore_phaseinjector1_rddata_rd_stb = csrbank2_dfii_pi1_rddata0_we;
...
always @(*) begin
    ...
    case (litedramcore_choose_cmd_grant)
        1'd0: begin
            rhs_self8 = litedramcore_choose_cmd_valids[0];
        end
        1'd1: begin
            rhs_self8 = litedramcore_choose_cmd_valids[1];
        end
        2'd2: begin
            rhs_self8 = litedramcore_choose_cmd_valids[2];
        end
        2'd3: begin
            rhs_self8 = litedramcore_choose_cmd_valids[3];
        end
        3'd4: begin
            rhs_self8 = litedramcore_choose_cmd_valids[4];
        end
        3'd5: begin
            rhs_self8 = litedramcore_choose_cmd_valids[5];
        end
        3'd6: begin
            rhs_self8 = litedramcore_choose_cmd_valids[6];
        end
        default: begin
            rhs_self8 = litedramcore_choose_cmd_valids[7];
        end
    endcase
end
always @(*) begin
    ...
    case (litedramcore_choose_cmd_grant)
        1'd0: begin
            rhs_self9 = litedramcore_bankmachine0_cmd_payload_a;
        end
        1'd1: begin
            rhs_self9 = litedramcore_bankmachine1_cmd_payload_a;
        end
        2'd2: begin
            rhs_self9 = litedramcore_bankmachine2_cmd_payload_a;
        end
        2'd3: begin
            rhs_self9 = litedramcore_bankmachine3_cmd_payload_a;
        end
        3'd4: begin
            rhs_self9 = litedramcore_bankmachine4_cmd_payload_a;
        end
        3'd5: begin
            rhs_self9 = litedramcore_bankmachine5_cmd_payload_a;
        end
        3'd6: begin
            rhs_self9 = litedramcore_bankmachine6_cmd_payload_a;
        end
        default: begin
            rhs_self9 = litedramcore_bankmachine7_cmd_payload_a;
        end
    endcase
end
always @(*) begin
    ...
    case (litedramcore_choose_cmd_grant)
        1'd0: begin
            rhs_self10 = litedramcore_bankmachine0_cmd_payload_ba;
        end
        1'd1: begin
            rhs_self10 = litedramcore_bankmachine1_cmd_payload_ba;
        end
        2'd2: begin
            rhs_self10 = litedramcore_bankmachine2_cmd_payload_ba;
        end
        2'd3: begin
            rhs_self10 = litedramcore_bankmachine3_cmd_payload_ba;
        end
        3'd4: begin
            rhs_self10 = litedramcore_bankmachine4_cmd_payload_ba;
        end
        3'd5: begin
            rhs_self10 = litedramcore_bankmachine5_cmd_payload_ba;
        end
        3'd6: begin
            rhs_self10 = litedramcore_bankmachine6_cmd_payload_ba;
        end
        default: begin
            rhs_self10 = litedramcore_bankmachine7_cmd_payload_ba;
        end
    endcase
end
always @(*) begin
    ...
    case (litedramcore_choose_cmd_grant)
        1'd0: begin
            rhs_self11 = litedramcore_bankmachine0_cmd_payload_is_read;
        end
        1'd1: begin
            rhs_self11 = litedramcore_bankmachine1_cmd_payload_is_read;
        end
        2'd2: begin
            rhs_self11 = litedramcore_bankmachine2_cmd_payload_is_read;
        end
        2'd3: begin
            rhs_self11 = litedramcore_bankmachine3_cmd_payload_is_read;
        end
        3'd4: begin
            rhs_self11 = litedramcore_bankmachine4_cmd_payload_is_read;
        end
        3'd5: begin
            rhs_self11 = litedramcore_bankmachine5_cmd_payload_is_read;
        end
        3'd6: begin
            rhs_self11 = litedramcore_bankmachine6_cmd_payload_is_read;
        end
        default: begin
            rhs_self11 = litedramcore_bankmachine7_cmd_payload_is_read;
        end
    endcase
end
always @(*) begin
    ...
    case (litedramcore_choose_cmd_grant)
        1'd0: begin
            rhs_self12 = litedramcore_bankmachine0_cmd_payload_is_write;
        end
        1'd1: begin
            rhs_self12 = litedramcore_bankmachine1_cmd_payload_is_write;
        end
        2'd2: begin
            rhs_self12 = litedramcore_bankmachine2_cmd_payload_is_write;
        end
        2'd3: begin
            rhs_self12 = litedramcore_bankmachine3_cmd_payload_is_write;
        end
        3'd4: begin
            rhs_self12 = litedramcore_bankmachine4_cmd_payload_is_write;
        end
        3'd5: begin
            rhs_self12 = litedramcore_bankmachine5_cmd_payload_is_write;
        end
        3'd6: begin
            rhs_self12 = litedramcore_bankmachine6_cmd_payload_is_write;
        end
        default: begin
            rhs_self12 = litedramcore_bankmachine7_cmd_payload_is_write;
        end
    endcase
end
always @(*) begin
    ...
    case (litedramcore_choose_cmd_grant)
        1'd0: begin
            rhs_self13 = litedramcore_bankmachine0_cmd_payload_is_cmd;
        end
        1'd1: begin
            rhs_self13 = litedramcore_bankmachine1_cmd_payload_is_cmd;
        end
        2'd2: begin
            rhs_self13 = litedramcore_bankmachine2_cmd_payload_is_cmd;
        end
        2'd3: begin
            rhs_self13 = litedramcore_bankmachine3_cmd_payload_is_cmd;
        end
        3'd4: begin
            rhs_self13 = litedramcore_bankmachine4_cmd_payload_is_cmd;
        end
        3'd5: begin
            rhs_self13 = litedramcore_bankmachine5_cmd_payload_is_cmd;
        end
        3'd6: begin
            rhs_self13 = litedramcore_bankmachine6_cmd_payload_is_cmd;
        end
        default: begin
            rhs_self13 = litedramcore_bankmachine7_cmd_payload_is_cmd;
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (litedramcore_choose_req_grant)
        1'd0: begin
            rhs_self14 = litedramcore_choose_req_valids[0];
        end
        1'd1: begin
            rhs_self14 = litedramcore_choose_req_valids[1];
        end
        2'd2: begin
            rhs_self14 = litedramcore_choose_req_valids[2];
        end
        2'd3: begin
            rhs_self14 = litedramcore_choose_req_valids[3];
        end
        3'd4: begin
            rhs_self14 = litedramcore_choose_req_valids[4];
        end
        3'd5: begin
            rhs_self14 = litedramcore_choose_req_valids[5];
        end
        3'd6: begin
            rhs_self14 = litedramcore_choose_req_valids[6];
        end
        default: begin
            rhs_self14 = litedramcore_choose_req_valids[7];
        end
    endcase
end
always @(*) begin
    ...
    case (litedramcore_choose_req_grant)
        1'd0: begin
            rhs_self15 = litedramcore_bankmachine0_cmd_payload_a;
        end
        1'd1: begin
            rhs_self15 = litedramcore_bankmachine1_cmd_payload_a;
        end
        2'd2: begin
            rhs_self15 = litedramcore_bankmachine2_cmd_payload_a;
        end
        2'd3: begin
            rhs_self15 = litedramcore_bankmachine3_cmd_payload_a;
        end
        3'd4: begin
            rhs_self15 = litedramcore_bankmachine4_cmd_payload_a;
        end
        3'd5: begin
            rhs_self15 = litedramcore_bankmachine5_cmd_payload_a;
        end
        3'd6: begin
            rhs_self15 = litedramcore_bankmachine6_cmd_payload_a;
        end
        default: begin
            rhs_self15 = litedramcore_bankmachine7_cmd_payload_a;
        end
    endcase
end
always @(*) begin
    ...
    case (litedramcore_choose_req_grant)
        1'd0: begin
            rhs_self16 = litedramcore_bankmachine0_cmd_payload_ba;
        end
        1'd1: begin
            rhs_self16 = litedramcore_bankmachine1_cmd_payload_ba;
        end
        2'd2: begin
            rhs_self16 = litedramcore_bankmachine2_cmd_payload_ba;
        end
        2'd3: begin
            rhs_self16 = litedramcore_bankmachine3_cmd_payload_ba;
        end
        3'd4: begin
            rhs_self16 = litedramcore_bankmachine4_cmd_payload_ba;
        end
        3'd5: begin
            rhs_self16 = litedramcore_bankmachine5_cmd_payload_ba;
        end
        3'd6: begin
            rhs_self16 = litedramcore_bankmachine6_cmd_payload_ba;
        end
        default: begin
            rhs_self16 = litedramcore_bankmachine7_cmd_payload_ba;
        end
    endcase
end
always @(*) begin
    ...
    case (litedramcore_choose_req_grant)
        1'd0: begin
            rhs_self17 = litedramcore_bankmachine0_cmd_payload_is_read;
        end
        1'd1: begin
            rhs_self17 = litedramcore_bankmachine1_cmd_payload_is_read;
        end
        2'd2: begin
            rhs_self17 = litedramcore_bankmachine2_cmd_payload_is_read;
        end
        2'd3: begin
            rhs_self17 = litedramcore_bankmachine3_cmd_payload_is_read;
        end
        3'd4: begin
            rhs_self17 = litedramcore_bankmachine4_cmd_payload_is_read;
        end
        3'd5: begin
            rhs_self17 = litedramcore_bankmachine5_cmd_payload_is_read;
        end
        3'd6: begin
            rhs_self17 = litedramcore_bankmachine6_cmd_payload_is_read;
        end
        default: begin
            rhs_self17 = litedramcore_bankmachine7_cmd_payload_is_read;
        end
    endcase
end
always @(*) begin
    ...
    case (litedramcore_choose_req_grant)
        1'd0: begin
            rhs_self18 = litedramcore_bankmachine0_cmd_payload_is_write;
        end
        1'd1: begin
            rhs_self18 = litedramcore_bankmachine1_cmd_payload_is_write;
        end
        2'd2: begin
            rhs_self18 = litedramcore_bankmachine2_cmd_payload_is_write;
        end
        2'd3: begin
            rhs_self18 = litedramcore_bankmachine3_cmd_payload_is_write;
        end
        3'd4: begin
            rhs_self18 = litedramcore_bankmachine4_cmd_payload_is_write;
        end
        3'd5: begin
            rhs_self18 = litedramcore_bankmachine5_cmd_payload_is_write;
        end
        3'd6: begin
            rhs_self18 = litedramcore_bankmachine6_cmd_payload_is_write;
        end
        default: begin
            rhs_self18 = litedramcore_bankmachine7_cmd_payload_is_write;
        end
    endcase
end
always @(*) begin
    ...
    case (litedramcore_choose_req_grant)
        1'd0: begin
            rhs_self19 = litedramcore_bankmachine0_cmd_payload_is_cmd;
        end
        1'd1: begin
            rhs_self19 = litedramcore_bankmachine1_cmd_payload_is_cmd;
        end
        2'd2: begin
            rhs_self19 = litedramcore_bankmachine2_cmd_payload_is_cmd;
        end
        2'd3: begin
            rhs_self19 = litedramcore_bankmachine3_cmd_payload_is_cmd;
        end
        3'd4: begin
            rhs_self19 = litedramcore_bankmachine4_cmd_payload_is_cmd;
        end
        3'd5: begin
            rhs_self19 = litedramcore_bankmachine5_cmd_payload_is_cmd;
        end
        3'd6: begin
            rhs_self19 = litedramcore_bankmachine6_cmd_payload_is_cmd;
        end
        default: begin
            rhs_self19 = litedramcore_bankmachine7_cmd_payload_is_cmd;
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (roundrobin0_grant)
        default: begin
            rhs_self20 = {user_port_cmd_payload_addr[24:10], user_port_cmd_payload_addr[6:0]};
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin0_grant)
        default: begin
            rhs_self21 = user_port_cmd_payload_we;
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin0_grant)
        default: begin
            rhs_self22 = (((user_port_cmd_payload_addr[9:7] == 1'd0) & (~(((((((locked0 | (litedramcore_interface_bank1_lock & (roundrobin1_grant == 1'd0))) | (litedramcore_interface_bank2_lock & (roundrobin2_grant == 1'd0))) | (litedramcore_interface_bank3_lock & (roundrobin3_grant == 1'd0))) | (litedramcore_interface_bank4_lock & (roundrobin4_grant == 1'd0))) | (litedramcore_interface_bank5_lock & (roundrobin5_grant == 1'd0))) | (litedramcore_interface_bank6_lock & (roundrobin6_grant == 1'd0))) | (litedramcore_interface_bank7_lock & (roundrobin7_grant == 1'd0))))) & user_port_cmd_valid);
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin1_grant)
        default: begin
            rhs_self23 = {user_port_cmd_payload_addr[24:10], user_port_cmd_payload_addr[6:0]};
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin1_grant)
        default: begin
            rhs_self24 = user_port_cmd_payload_we;
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin1_grant)
        default: begin
            rhs_self25 = (((user_port_cmd_payload_addr[9:7] == 1'd1) & (~(((((((locked1 | (litedramcore_interface_bank0_lock & (roundrobin0_grant == 1'd0))) | (litedramcore_interface_bank2_lock & (roundrobin2_grant == 1'd0))) | (litedramcore_interface_bank3_lock & (roundrobin3_grant == 1'd0))) | (litedramcore_interface_bank4_lock & (roundrobin4_grant == 1'd0))) | (litedramcore_interface_bank5_lock & (roundrobin5_grant == 1'd0))) | (litedramcore_interface_bank6_lock & (roundrobin6_grant == 1'd0))) | (litedramcore_interface_bank7_lock & (roundrobin7_grant == 1'd0))))) & user_port_cmd_valid);
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin2_grant)
        default: begin
            rhs_self26 = {user_port_cmd_payload_addr[24:10], user_port_cmd_payload_addr[6:0]};
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin2_grant)
        default: begin
            rhs_self27 = user_port_cmd_payload_we;
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin2_grant)
        default: begin
            rhs_self28 = (((user_port_cmd_payload_addr[9:7] == 2'd2) & (~(((((((locked2 | (litedramcore_interface_bank0_lock & (roundrobin0_grant == 1'd0))) | (litedramcore_interface_bank1_lock & (roundrobin1_grant == 1'd0))) | (litedramcore_interface_bank3_lock & (roundrobin3_grant == 1'd0))) | (litedramcore_interface_bank4_lock & (roundrobin4_grant == 1'd0))) | (litedramcore_interface_bank5_lock & (roundrobin5_grant == 1'd0))) | (litedramcore_interface_bank6_lock & (roundrobin6_grant == 1'd0))) | (litedramcore_interface_bank7_lock & (roundrobin7_grant == 1'd0))))) & user_port_cmd_valid);
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin3_grant)
        default: begin
            rhs_self29 = {user_port_cmd_payload_addr[24:10], user_port_cmd_payload_addr[6:0]};
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin3_grant)
        default: begin
            rhs_self30 = user_port_cmd_payload_we;
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin3_grant)
        default: begin
            rhs_self31 = (((user_port_cmd_payload_addr[9:7] == 2'd3) & (~(((((((locked3 | (litedramcore_interface_bank0_lock & (roundrobin0_grant == 1'd0))) | (litedramcore_interface_bank1_lock & (roundrobin1_grant == 1'd0))) | (litedramcore_interface_bank2_lock & (roundrobin2_grant == 1'd0))) | (litedramcore_interface_bank4_lock & (roundrobin4_grant == 1'd0))) | (litedramcore_interface_bank5_lock & (roundrobin5_grant == 1'd0))) | (litedramcore_interface_bank6_lock & (roundrobin6_grant == 1'd0))) | (litedramcore_interface_bank7_lock & (roundrobin7_grant == 1'd0))))) & user_port_cmd_valid);
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin4_grant)
        default: begin
            rhs_self32 = {user_port_cmd_payload_addr[24:10], user_port_cmd_payload_addr[6:0]};
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin4_grant)
        default: begin
            rhs_self33 = user_port_cmd_payload_we;
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin4_grant)
        default: begin
            rhs_self34 = (((user_port_cmd_payload_addr[9:7] == 3'd4) & (~(((((((locked4 | (litedramcore_interface_bank0_lock & (roundrobin0_grant == 1'd0))) | (litedramcore_interface_bank1_lock & (roundrobin1_grant == 1'd0))) | (litedramcore_interface_bank2_lock & (roundrobin2_grant == 1'd0))) | (litedramcore_interface_bank3_lock & (roundrobin3_grant == 1'd0))) | (litedramcore_interface_bank5_lock & (roundrobin5_grant == 1'd0))) | (litedramcore_interface_bank6_lock & (roundrobin6_grant == 1'd0))) | (litedramcore_interface_bank7_lock & (roundrobin7_grant == 1'd0))))) & user_port_cmd_valid);
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin5_grant)
        default: begin
            rhs_self35 = {user_port_cmd_payload_addr[24:10], user_port_cmd_payload_addr[6:0]};
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin5_grant)
        default: begin
            rhs_self36 = user_port_cmd_payload_we;
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin5_grant)
        default: begin
            rhs_self37 = (((user_port_cmd_payload_addr[9:7] == 3'd5) & (~(((((((locked5 | (litedramcore_interface_bank0_lock & (roundrobin0_grant == 1'd0))) | (litedramcore_interface_bank1_lock & (roundrobin1_grant == 1'd0))) | (litedramcore_interface_bank2_lock & (roundrobin2_grant == 1'd0))) | (litedramcore_interface_bank3_lock & (roundrobin3_grant == 1'd0))) | (litedramcore_interface_bank4_lock & (roundrobin4_grant == 1'd0))) | (litedramcore_interface_bank6_lock & (roundrobin6_grant == 1'd0))) | (litedramcore_interface_bank7_lock & (roundrobin7_grant == 1'd0))))) & user_port_cmd_valid);
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin6_grant)
        default: begin
            rhs_self38 = {user_port_cmd_payload_addr[24:10], user_port_cmd_payload_addr[6:0]};
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin6_grant)
        default: begin
            rhs_self39 = user_port_cmd_payload_we;
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin6_grant)
        default: begin
            rhs_self40 = (((user_port_cmd_payload_addr[9:7] == 3'd6) & (~(((((((locked6 | (litedramcore_interface_bank0_lock & (roundrobin0_grant == 1'd0))) | (litedramcore_interface_bank1_lock & (roundrobin1_grant == 1'd0))) | (litedramcore_interface_bank2_lock & (roundrobin2_grant == 1'd0))) | (litedramcore_interface_bank3_lock & (roundrobin3_grant == 1'd0))) | (litedramcore_interface_bank4_lock & (roundrobin4_grant == 1'd0))) | (litedramcore_interface_bank5_lock & (roundrobin5_grant == 1'd0))) | (litedramcore_interface_bank7_lock & (roundrobin7_grant == 1'd0))))) & user_port_cmd_valid);
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin7_grant)
        default: begin
            rhs_self41 = {user_port_cmd_payload_addr[24:10], user_port_cmd_payload_addr[6:0]};
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin7_grant)
        default: begin
            rhs_self42 = user_port_cmd_payload_we;
        end
    endcase
end
always @(*) begin
    ...
    case (roundrobin7_grant)
        default: begin
            rhs_self43 = (((user_port_cmd_payload_addr[9:7] == 3'd7) & (~(((((((locked7 | (litedramcore_interface_bank0_lock & (roundrobin0_grant == 1'd0))) | (litedramcore_interface_bank1_lock & (roundrobin1_grant == 1'd0))) | (litedramcore_interface_bank2_lock & (roundrobin2_grant == 1'd0))) | (litedramcore_interface_bank3_lock & (roundrobin3_grant == 1'd0))) | (litedramcore_interface_bank4_lock & (roundrobin4_grant == 1'd0))) | (litedramcore_interface_bank5_lock & (roundrobin5_grant == 1'd0))) | (litedramcore_interface_bank6_lock & (roundrobin6_grant == 1'd0))))) & user_port_cmd_valid);
        end
    endcase
end
always @(*) begin
...
always @(posedge sys_clk) begin
    ...
    if ((litedramcore_timer_wait & (~litedramcore_timer_done0))) begin
        ...
        litedramcore_timer_count1 <= 10'd585;
    end
    ...
    if ((litedramcore_sequencer_start1 & (litedramcore_sequencer_trigger == 1'd0))) begin
        litedramcore_cmd_payload_a <= 11'h400;
        litedramcore_cmd_payload_ba <= 1'd0;
        litedramcore_cmd_payload_cas <= 1'd0;
    ...
    if ((litedramcore_zqcs_timer_wait & (~litedramcore_zqcs_timer_done0))) begin
        ...
        litedramcore_zqcs_timer_count1 <= 27'd74999999;
    end
    ...
    if (litedramcore_bankmachine0_trccon_valid) begin
        litedramcore_bankmachine0_trccon_count <= 3'd4;
        if (1'd0) begin
    ...
    if (litedramcore_bankmachine0_trascon_valid) begin
        litedramcore_bankmachine0_trascon_count <= 2'd3;
        if (1'd0) begin
    ...
    if (litedramcore_bankmachine1_trccon_valid) begin
        litedramcore_bankmachine1_trccon_count <= 3'd4;
        if (1'd0) begin
    ...
    if (litedramcore_bankmachine1_trascon_valid) begin
        litedramcore_bankmachine1_trascon_count <= 2'd3;
        if (1'd0) begin
    ...
    if (litedramcore_bankmachine2_trccon_valid) begin
        litedramcore_bankmachine2_trccon_count <= 3'd4;
        if (1'd0) begin
    ...
    if (litedramcore_bankmachine2_trascon_valid) begin
        litedramcore_bankmachine2_trascon_count <= 2'd3;
        if (1'd0) begin
    ...
    if (litedramcore_bankmachine3_trccon_valid) begin
        litedramcore_bankmachine3_trccon_count <= 3'd4;
        if (1'd0) begin
    ...
    if (litedramcore_bankmachine3_trascon_valid) begin
        litedramcore_bankmachine3_trascon_count <= 2'd3;
        if (1'd0) begin
    ...
    if (litedramcore_bankmachine4_trccon_valid) begin
        litedramcore_bankmachine4_trccon_count <= 3'd4;
        if (1'd0) begin
    ...
    if (litedramcore_bankmachine4_trascon_valid) begin
        litedramcore_bankmachine4_trascon_count <= 2'd3;
        if (1'd0) begin
    ...
    if (litedramcore_bankmachine5_trccon_valid) begin
        litedramcore_bankmachine5_trccon_count <= 3'd4;
        if (1'd0) begin
    ...
    if (litedramcore_bankmachine5_trascon_valid) begin
        litedramcore_bankmachine5_trascon_count <= 2'd3;
        if (1'd0) begin
    ...
    if (litedramcore_bankmachine6_trccon_valid) begin
        litedramcore_bankmachine6_trccon_count <= 3'd4;
        if (1'd0) begin
    ...
    if (litedramcore_bankmachine6_trascon_valid) begin
        litedramcore_bankmachine6_trascon_count <= 2'd3;
        if (1'd0) begin
    ...
    if (litedramcore_bankmachine7_trccon_valid) begin
        litedramcore_bankmachine7_trccon_count <= 3'd4;
        if (1'd0) begin
    ...
    if (litedramcore_bankmachine7_trascon_valid) begin
        litedramcore_bankmachine7_trascon_count <= 2'd3;
        if (1'd0) begin
    ...
    if (litedramcore_trrdcon_valid) begin
        litedramcore_trrdcon_count <= 2'd2;
        if (1'd0) begin
    ...
    if (csrbank0_init_done_re) begin
        init_done_storage <= csrbank0_init_done_r;
    end
    init_done_wr_stb <= csrbank0_init_done_re;
    if (csrbank0_init_error_re) begin
        init_error_storage <= csrbank0_init_error_r;
    end
    init_error_wr_stb <= csrbank0_init_error_re;
    interface1_bank_bus_dat_r <= 1'd0;
    if (csrbank1_sel) begin
        case (interface1_bank_bus_adr[8:0])
            1'd0: begin
                interface1_bank_bus_dat_r <= csrbank1_dly_sel_w;
            end
            1'd1: begin
    ...
    if (csrbank1_dly_sel_re) begin
        ddrphy_dly_sel_storage <= csrbank1_dly_sel_r;
    end
    ddrphy_dly_sel_wr_stb <= csrbank1_dly_sel_re;
    ddrphy_burstdet_seen_wr_stb <= csrbank1_burstdet_seen_re;
    ...
    if (csrbank2_dfii_control_re) begin
        litedramcore_storage <= csrbank2_dfii_control_r;
    end
    litedramcore_wr_stb <= csrbank2_dfii_control_re;
    if (csrbank2_dfii_pi0_command_re) begin
        litedramcore_phaseinjector0_command_storage <= csrbank2_dfii_pi0_command_r;
    end
    litedramcore_phaseinjector0_command_wr_stb <= csrbank2_dfii_pi0_command_re;
    if (csrbank2_dfii_pi0_address_re) begin
        litedramcore_phaseinjector0_address_storage <= csrbank2_dfii_pi0_address_r;
    end
    litedramcore_phaseinjector0_address_wr_stb <= csrbank2_dfii_pi0_address_re;
    if (csrbank2_dfii_pi0_baddress_re) begin
        litedramcore_phaseinjector0_baddress_storage <= csrbank2_dfii_pi0_baddress_r;
    end
    litedramcore_phaseinjector0_baddress_wr_stb <= csrbank2_dfii_pi0_baddress_re;
    ...
    litedramcore_phaseinjector0_wrdata_wr_stb <= csrbank2_dfii_pi0_wrdata0_re;
    litedramcore_phaseinjector0_rddata_wr_stb <= csrbank2_dfii_pi0_rddata0_re;
    if (csrbank2_dfii_pi1_command_re) begin
        litedramcore_phaseinjector1_command_storage <= csrbank2_dfii_pi1_command_r;
    end
    litedramcore_phaseinjector1_command_wr_stb <= csrbank2_dfii_pi1_command_re;
    if (csrbank2_dfii_pi1_address_re) begin
        litedramcore_phaseinjector1_address_storage <= csrbank2_dfii_pi1_address_r;
    end
    litedramcore_phaseinjector1_address_wr_stb <= csrbank2_dfii_pi1_address_re;
    if (csrbank2_dfii_pi1_baddress_re) begin
        litedramcore_phaseinjector1_baddress_storage <= csrbank2_dfii_pi1_baddress_r;
    end
    litedramcore_phaseinjector1_baddress_wr_stb <= csrbank2_dfii_pi1_baddress_re;
    ...
    litedramcore_phaseinjector1_wrdata_wr_stb <= csrbank2_dfii_pi1_wrdata0_re;
    litedramcore_phaseinjector1_rddata_wr_stb <= csrbank2_dfii_pi1_rddata0_re;
    if (sys_rst) begin
        ddrphy_dly_sel_storage <= 2'd0;
        ddrphy_dly_sel_wr_stb <= 1'd0;
        ddrphy_burstdet_seen_status <= 2'd0;
        ddrphy_burstdet_seen_wr_stb <= 1'd0;
        ddrphy_rdly0 <= 3'd0;
        ...
        litedramcore_wr_stb <= 1'd0;
        litedramcore_phaseinjector0_command_storage <= 8'd0;
        litedramcore_phaseinjector0_command_wr_stb <= 1'd0;
        litedramcore_phaseinjector0_address_wr_stb <= 1'd0;
        litedramcore_phaseinjector0_baddress_wr_stb <= 1'd0;
        litedramcore_phaseinjector0_wrdata_wr_stb <= 1'd0;
        litedramcore_phaseinjector0_rddata_status <= 64'd0;
        litedramcore_phaseinjector0_rddata_wr_stb <= 1'd0;
        litedramcore_phaseinjector1_command_storage <= 8'd0;
        litedramcore_phaseinjector1_command_wr_stb <= 1'd0;
        litedramcore_phaseinjector1_address_wr_stb <= 1'd0;
        litedramcore_phaseinjector1_baddress_wr_stb <= 1'd0;
        litedramcore_phaseinjector1_wrdata_wr_stb <= 1'd0;
        litedramcore_phaseinjector1_rddata_status <= 64'd0;
        litedramcore_phaseinjector1_rddata_wr_stb <= 1'd0;
        ...
        litedramcore_trrdcon_ready <= 1'd0;
        litedramcore_trrdcon_count <= 2'd0;
        litedramcore_tfawcon_ready <= 1'd1;
        ...
        init_done_wr_stb <= 1'd0;
        init_error_storage <= 1'd0;
        init_error_wr_stb <= 1'd0;
        user_enable <= 1'd0;
        interface1_re <= 1'd0;
        interface1_we <= 1'd0;
        selected_r <= 1'd0;
...
(* FREQUENCY_PIN_CLKI = "16.0", FREQUENCY_PIN_CLKOP = "150.0", FREQUENCY_PIN_CLKOS = "25.0", ICP_CURRENT = "6", LPF_RESISTOR = "16", MFG_ENABLE_FILTEROPAMP = "1", MFG_GMCREF_SEL = "2" *)
//------------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2026-09-16 08:16:19.
//------------------------------------------------------------------------------
